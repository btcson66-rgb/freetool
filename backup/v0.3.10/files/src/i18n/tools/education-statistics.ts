...
export const percentileRankContent = content(
  ...
  },
  {
    ...
    seoTitle: 'Percentile Rank Calculator | Formula and Education Guide', seoDescription: 'Calculate percentile rank using counts below, tied scores, and group size, with formula and reporting guidance.',
...
export const weightedAverageContent = content(
  ...
  },
  {
    ...
    seoTitle: 'Weighted Average Calculator | Values, Weights, Formula', seoDescription: 'Calculate a weighted average from multiple values and weights with education and reporting guidance.', keywords: ['weighted average calculator', 'weighted mean', 'grade weights'],
...
export const classRankContent = content(
  ...
  },
  {
    ...
    seoTitle: 'Class Rank Percentile Calculator | Rank to Percentile', seoDescription: 'Convert class rank and class size to an estimated percentile rank and top percentage.', keywords: ['class rank percentile calculator', 'rank percentage', 'education statistics'],
...
export const normalizedScoreContent = content(
  ...
  },
  {
    ...
    seoTitle: 'Normalized Score Converter | Standard Score Transformation', seoDescription: 'Convert a raw score to a target mean and standard deviation, with z score, formula, and reporting guidance.', keywords: ['normalized score converter', 'standard score transformation', 'linear standardization'],
...
export const teacherExamContent = content(
  {
    ...
    labels: { written: '筆試成績', writtenWeight: '筆試權重', interview: '口試成績', interviewWeight: '口試權重', teaching: '試教成績', teachingWeight: '試教權重', calculate: '模擬加權總成績', result: '模擬總成績', weightTotal: '權重總和', invalid: '請輸入有效成績與非負權重，且至少一項權重大於 0。' }, disclaimer: disclaimer.zh, privacyNote: privacy.zh,
  },
  {
    ...
    seoTitle: 'Teacher Exam Score Converter | Weighted Score Simulator', seoDescription: 'Simulate a weighted total from written, interview, and teaching-demonstration scores.', keywords: ['teacher exam score converter', 'teacher recruitment score', 'weighted exam score'],
...
export const cronbachAlphaContent = content(
  ...
  },
  {
    ...
    seoTitle: 'Cronbach Alpha Calculator | Internal Consistency Estimate', seoDescription: 'Paste respondent-by-item data to estimate Cronbach alpha, sample size, and item count.', keywords: ['Cronbach alpha calculator', 'internal consistency', 'reliability analysis'],
