...
export default {
  ...
  en: {
    ...
    privacyNote: 'Your custom Pomodoro minute settings are stored only in this browser using localStorage. Free Tools Hub does not receive your timer settings, session count, or usage history.',
