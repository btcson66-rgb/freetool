...
export default {
  zh: {
    ...
    seoTitle: '房貸月付試算器 | 免費估算 Mortgage Payment',
    seoDescription: '輸入貸款金額、年利率與年限，估算每月房貸、總付款與總利息。適合初步預算、看屋比較與貸款情境試算。',
    ...
    disclaimer: '僅供估算。實際房貸可能包含寬限期、浮動或階梯利率、手續費、保險、稅費與其他條件，請以銀行與正式貸款文件為準。',
  ...
  en: {
    ...
    disclaimer: 'Estimate only. Real loans may include grace periods, adjustable or tiered rates, fees, insurance, taxes, and other conditions. Confirm with the lender and formal loan documents.',
