...
export default {
  zh: {
    ...
    seoTitle: '隨機數字產生器｜免費線上抽號碼與亂數工具',
    seoDescription: '免費線上隨機數字產生器，可設定最小值、最大值、抽取數量、是否允許重複與結果排序，適合抽獎、課堂點號與測試資料。',
    ...
    privacyNote: '此工具在瀏覽器本機產生亂數與結果。你輸入的最小值、最大值、抽取數量與結果不會傳送到 Free Tools Hub 伺服器。',
  ...
  en: {
    ...
    privacyNote: 'This tool generates the random values locally in your browser. Your range, quantity, and results are not sent to Free Tools Hub servers.',
