...
const prioritySpecs: PrioritySpec[] = [
  {
    ...
    zhSeoTitle: '教師甄試成績計算｜筆試口試試教加權模擬',
    enSeoTitle: 'Teacher Exam Score Calculator | Weighted Exam Simulation',
    zhSeoDescription: '輸入筆試、口試、試教與自訂權重，快速模擬教師甄試加權總分，適合考生整理範例與檢查計算。',
    enSeoDescription: 'Simulate a weighted teacher-exam total from written, interview, and teaching-demo scores with custom weights.',
